...
public class SortUtil
{
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        ...
        if (camelToUnderscore) {
            sortField = CommonUtil.camelToUnderscore(sortField);
            defaultSort = CommonUtil.camelToUnderscore(defaultSort);
        }
        ...
        {
            if (StringUtils.equals(request.getOrder(), CommonUtil.ORDER_DESC))
            ...
            if (StringUtils.isNotBlank(defaultSort)) {
                if (StringUtils.equals(defaultOrder, CommonUtil.ORDER_DESC))
